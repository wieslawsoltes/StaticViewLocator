...
{
    public sealed class DashboardScreen : Framework.FrameworkView<Models.DashboardModel>
    {
    }
}
...
""";
        ...
        Assert.Contains(
            "[typeof(TestApp.Models.DashboardModel)] = () => new TestApp.Screens.DashboardScreen()",
            locatorSource,
            StringComparison.Ordinal);
        Assert.Contains("private static bool TryCreateViewExact", locatorSource, StringComparison.Ordinal);
        Assert.DoesNotContain("GetInterfaces()", locatorSource, StringComparison.Ordinal);
    }

    [Fact]
    public async Task ExplicitMappingOverridesGenericBaseContractMapping()
    {
        const string input = """
using Avalonia.Controls;
using StaticViewLocator;
...
namespace TestApp.Framework
{
    public abstract class FrameworkView<TViewModel> : UserControl
    {
    }
}
...
namespace TestApp.Screens
{
    ...
    public sealed class AlternateDashboardScreen : UserControl
    {
    }
}
...
{
    [StaticViewLocator(
        ViewModelMappingContracts = new[] { typeof(Framework.FrameworkView<>) })]
    [StaticViewMapping(typeof(Models.DashboardModel), typeof(Screens.AlternateDashboardScreen))]
    public partial class ViewLocator
    {
    }
}
""";
        ...
        Assert.Contains(
            "[typeof(TestApp.Models.DashboardModel)] = () => new TestApp.Screens.AlternateDashboardScreen()",
            locatorSource,
            StringComparison.Ordinal);
