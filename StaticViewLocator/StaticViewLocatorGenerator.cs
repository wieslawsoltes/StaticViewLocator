...
public sealed partial class StaticViewLocatorGenerator : IIncrementalGenerator
{
        ...
        GeneratorOptions options)
    {
        ...
        var dataTemplateBuildMethodExists = HasDataTemplateBuildMethod(locatorSymbol);
        var dataTemplateMatchMethodExists = HasDataTemplateMatchMethod(locatorSymbol);
        ...
        {
            foreach (var mapping in GetReactiveUIMappings(compilation, viewBaseTypes))
            {
        ...
        var source = new StringBuilder(
            ...
            public partial class {{classNameLocator}}{{generatedInterfacesClause}}
            {
            """);
        ...
        if ((ShouldGenerateViewFactoryMethods(locatorSymbol) || generateIViewLocator || generateIDataTemplate) &&
            !HasTryCreateViewExact(locatorSymbol))
        {
            source.Append(
                """
...
""");
        ...
        if (generateIViewLocator)
        {
            AppendIViewLocator(source, locatorSymbol);
        }
...
""");
        ...
        {
            AppendDataTemplateBuild(source, locatorSymbol, generateIViewLocator);
        }

        if (generateIDataTemplate && !dataTemplateMatchMethodExists)
        {
            AppendDataTemplateMatch(source, locatorSymbol);
        }
